...
public class TortoiseInSpace implements KeyEventDispatcher {
	...
	Tortoise.move(-10);
		...
		else if (keyPressed == 39) {Tortoise.turn(90);
		Tortoise.move(10);
		Tortoise.turn(-90);
	...
	public void playEureka() {
		...
		try {
			AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new File("/Users/League/Google Drive/league-sounds/cat-lazer.wav"));
